...
void MainWindow::initialize() {
    ...
    QLabel *soft_shadow_label = new QLabel(); // soft shadow label
    soft_shadow_label->setText("Soft Shadows");
    soft_shadow_label->setFont(font);
    ...
    softShadowsBox = new QCheckBox();
    softShadowsBox->setText(QStringLiteral("Soft Shadows (PCF)"));
    softShadowsBox->setChecked(false);
    ...
    vLayout->addWidget(soft_shadow_label);
    vLayout->addWidget(softShadowsBox);
...
void MainWindow::connectSoftShadows() {
    connect(softShadowsBox, &QCheckBox::clicked, this, &MainWindow::onSoftShadows);
}
...
void MainWindow::onSoftShadows() {
    settings.softShadows = softShadowsBox->isChecked();
    realtime->settingsChanged();
}
