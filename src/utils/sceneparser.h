...
public:
    ...
    static void parseMesh(std::vector<RenderShapeData>& shapes, ScenePrimitive* shape, glm::mat4 ptm);
    static void sceneDFS(SceneNode* root, glm::mat4 ptm, std::vector<SceneLightData>& lights, std::vector<RenderShapeData>& shapes);

    static glm::mat4 parseSceneTransform(SceneTransformation* trans);
};
